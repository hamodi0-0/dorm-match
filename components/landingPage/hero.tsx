          ...
          <div className="grid grid-cols-1 md:grid-cols-[1fr_1.6fr] gap-10 md:gap-4 items-center">
            ...
            <div className="relative w-full flex items-center justify-end">
              <div className="relative w-full aspect-4/3 md:-mr-16 lg:-mr-32">
                {/* Main orange bubble */}
                <div className="absolute left-6 top-4 z-0 h-36 w-36 rounded-[2rem] bg-primary/18 dark:bg-primary/60 shadow-[0_26px_50px_-36px_rgba(0,0,0,0.35)] ring-1 ring-primary/20 md:left-24 md:top-16 md:h-56 md:w-56"></div>
                {/* Match card */}
                <div className="absolute right-6 top-4 z-0 h-20 w-20 rounded-[1.5rem] border border-border/70 dark:border-border dark:bg-muted/99 bg-card/90 shadow-[0_22px_40px_-30px_rgba(0,0,0,0.35)] backdrop-blur-sm md:right-20 md:top-16 md:h-28 md:w-28 lg:right-18 lg:top-16">
                  <div className="flex h-full w-full items-center justify-center p-3"></div>
                </div>
                {/* Join button mock */}
                <div className="absolute left-2 bottom-0 z-0 flex h-20 w-28 -rotate-3 items-center justify-center rounded-4xl border border-border/70 bg-background/95  dark:border-border dark:bg-muted/99 shadow-[0_18px_36px_-28px_rgba(0,0,0,0.35)] md:left-14 md:bottom-16 md:h-22 md:w-32 lg:left-16 lg:bottom-14" />
                {/* Small accent square */}
                <div className="absolute right-16 bottom-6 z-0 h-14 w-14 rounded-[1.35rem] dark:bg-primary/60 bg-primary/15 shadow-[0_16px_32px_-24px_rgba(0,0,0,0.35)] md:right-36 md:bottom-14 md:h-16 md:w-16 lg:right-40 lg:bottom-30" />
                ...
                <Image
                  ...
                  className="relative z-10 object-contain scale-110 md:scale-[1.08]"
                />
              </div>
            </div>
          </div>
