          ...
          <div className="grid grid-cols-1 md:grid-cols-[1fr_1.6fr] gap-10 md:gap-4 items-center">
            ...
            <div className="max-w-2xl space-y-6">
              <div className="flex items-center">
                <span className="rounded-full inline-flex items-center gap-2 bg-green-500/20 pr-5 pl-3 py-2 text-sm font-bold tracking-wide dark:text-green-500 text-green-700 shadow-sm">
                  <SparkleIcon className="h-4 w-4 mr-2 dark:text-green-500 text-green-800 animate-pulse" />
            ...
            <div className="relative w-full flex items-center justify-end">
              <div className="group relative w-full aspect-4/3 md:-mr-16 lg:-mr-32">
                ...
                {/* Join button mock */}
                <div className="absolute left-2 bottom-0 z-0 flex h-20 w-28 -rotate-3 items-center justify-center rounded-4xl border border-border/70 bg-background/95  dark:border-border dark:bg-muted/99 shadow-[0_18px_36px_-28px_rgba(0,0,0,0.35)] transition-transform duration-300 hover:scale-110 md:left-14 md:bottom-16 md:h-22 md:w-32 lg:left-16 lg:bottom-14" />
                {/* Small accent square */}
                <div className="absolute right-16 bottom-6 z-0 h-14 w-14 rounded-[1.35rem] dark:bg-primary/60 bg-primary/15 shadow-[0_16px_32px_-24px_rgba(0,0,0,0.35)] transition-transform duration-300 hover:scale-110 md:right-36 md:bottom-14 md:h-16 md:w-16 lg:right-40 lg:bottom-30" />
                ...
                <Image
                  ...
                  className="relative z-10 object-contain scale-110 md:scale-[1.08] pointer-events-none"
                />
              </div>
            </div>
          </div>
