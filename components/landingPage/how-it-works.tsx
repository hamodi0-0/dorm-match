...
export default function HowItWorks() {
  ...
  return (
    <FadeInSection>
      <section id="how-it-works" className="py-32 bg-accent/40">
        <div className="max-w-4xl mx-auto px-6">
                ...
                <CardContent className="p-8">
                  <div className="flex flex-col md:flex-row gap-6 items-start">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-muted-foreground text-lg mb-6">
                        Browse available listings, see your compatibility
                        scores, and connect with potential roommates. Your
          ...
          <div className="mt-16 text-center">
            <div className="inline-block rounded-xl border border-primary/40 bg-primary/8 px-6 py-4">
